This a sample client app for consuming profanity API : [http://profanityapp.azurewebsites.net/api/profanity]. Project is bootstrapped with React [https://reactjs.org/]
